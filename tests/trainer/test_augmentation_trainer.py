...
def load_and_update_config(tmpdir):
    ...
    config["trainer"]["preprocessing"] = {"class_name": "TestPreprocessingNNX"}
    config["trainer"]["augmentation"] = {
        "class_name": "GaussianNoiseAugmentationNNX",
        "scale": 0.1,
    }
...
def test_augmentation_trainer_nnx(tmpdir, cleanup_logging):
    """Test the AugmentationTrainer with NNX model."""
